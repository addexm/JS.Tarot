...
export default{
    draw: function (amount, inversion) {
        var items = this.data;
        ...
        return fisherYates(amount).map((random) => {
            return _.extend({}, items[random], { inverted: (typeof inversion !== 'undefined' ? inversion : (rand(2) ? true : false)) });
        });
    },
    data: [
        {
        ...
        },
        {
            ...
            "reversed": "Misery, distress, indigence, adversity, calamity, disgrace, deception, ruin in a lesser degree. Also oppression, imprisonment, tyranny."
        },
        {
            "index": 17,
            "name": "XVII - The Star",
        ...
        },
        {
            ...
            "reversed": "Material happiness, fortunate marriage, contentment in a lesser sense."
        },
        {
            "index": 20,
